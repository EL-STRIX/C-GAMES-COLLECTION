...
void apply_theme(int theme_id) {
    ...
    if (theme_id == 1) { const char *css_data = "window { background-color: #1e1e2e; } label { color: #cdd6f4; } .card { background-color: #1e1e2e; color: #cdd6f4; border: 1px solid #45475a; box-shadow: 0 0 10px rgba(255,255,255,0.1); } label, .header-title, .subtitle, .game-title, .game-desc, .name-question, .welcome-text, .result-small-text, .result-performance-text, .attempts-text, .success-text, .big-number, .tip-text, .warning-text { color: #cdd6f4; font-family: sans-serif; } button, .btn-launch, .btn-settings, .btn-blue { background-color: #89b4fa; color: #11111b; font-weight: bold; border: none; border-radius: 8px; } button label, .btn-launch label, .btn-settings label, .btn-blue label { color: #11111b; } button:hover, .btn-launch:hover, .btn-settings:hover, .btn-blue:hover { background-color: #b4befe; }"; theme_css = css_data; }
